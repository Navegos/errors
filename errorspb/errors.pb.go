...
type EncodedWrapper struct {
	...
	MessageType MessageType `protobuf:"varint,4,opt,name=message_type,json=messageType,proto3,enum=navegos.errorspb.MessageType" json:"message_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("navegos.errorspb.MessageType", MessageType_name, MessageType_value)
	proto.RegisterType((*EncodedError)(nil), "navegos.errorspb.EncodedError")
	proto.RegisterType((*EncodedErrorLeaf)(nil), "navegos.errorspb.EncodedErrorLeaf")
	proto.RegisterType((*EncodedErrorDetails)(nil), "navegos.errorspb.EncodedErrorDetails")
	proto.RegisterType((*EncodedWrapper)(nil), "navegos.errorspb.EncodedWrapper")
	proto.RegisterType((*ErrorTypeMark)(nil), "navegos.errorspb.ErrorTypeMark")
	proto.RegisterType((*StringsPayload)(nil), "navegos.errorspb.StringsPayload")
	proto.RegisterType((*ErrnoPayload)(nil), "navegos.errorspb.ErrnoPayload")
}
