...
(1)
  -- stack trace:
  | github.com/Navegos/errors/errbase_test.TestSimplifyStacks.func2
  | <tab><path>:<lineno>
  | [...repeated from below...]
Wraps: (2) hello world
  | github.com/Navegos/errors/errbase_test.TestSimplifyStacks.func1
  | <tab><path>:<lineno>
  | github.com/Navegos/errors/errbase_test.TestSimplifyStacks.func2
  | <tab><path>:<lineno>
  | github.com/Navegos/errors/errbase_test.TestSimplifyStacks
  | <tab><path>:<lineno>
  | testing.tRunner
  | <tab><path>:<lineno>
  | runtime.goexit
