...
import (
	...
	"github.com/Navegos/errors/domains"
	"github.com/Navegos/errors/errbase"
	"github.com/Navegos/errors/report"
	"github.com/Navegos/errors/safedetails"
	"github.com/Navegos/errors/testutils"
	"github.com/Navegos/errors/withstack"
...
Wraps: \(3\) attached stack trace
  -- stack trace:
  | github.com/Navegos/errors/report_test.TestReport
...
github.com/Navegos/errors/safedetails/*safedetails.withSafeDetails (*::)
github.com/Navegos/errors/withstack/*withstack.withStack (*::)
github.com/Navegos/errors/domains/*domains.withDomain (*::error domain: "thisdomain")
github.com/Navegos/errors/report_test/*report_test.myWrapper (some/previous/path/prevpkg.prevType::)
`
